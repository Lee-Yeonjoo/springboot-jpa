...
public class OrderSimpleApiController {
    ...
    public List<OrderSimpleQueryDto> ordersV4() {
        return orderSimpleQueryRepository.findOrderDtos(); //리포지토리는 순수한 엔티티를 조회하는 용도이고, 화면에 종속되는 dto를 조회하는 경우는 패키지를 따로 파고, 리포지토리도 따로 만드는게 좋다.(QueryService, QueryRepository) -> 유지보수성이 좋아진다.
    }
